...
func (*EchoMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_exserver_88aa69dfe8627805, []int{0}
}
...
type ExServerClient interface {
	...
	ConsumeEvent1(ctx context.Context, opts ...grpc.CallOption) (ExServer_ConsumeEvent1Client, error)
...
func (c *exServerClient) ConsumeEvent1(ctx context.Context, opts ...grpc.CallOption) (ExServer_ConsumeEvent1Client, error) {
	stream, err := c.cc.NewStream(ctx, &_ExServer_serviceDesc.Streams[1], "/exserverpb.ExServer/ConsumeEvent1", opts...)
	if err != nil {
		return nil, err
	}
	x := &exServerConsumeEvent1Client{stream}
	return x, nil
}

type ExServer_ConsumeEvent1Client interface {
	Send(*reflexpb.ConsumeRequest) error
	Recv() (*reflexpb.Event, error)
	grpc.ClientStream
}

type exServerConsumeEvent1Client struct {
	grpc.ClientStream
}

func (x *exServerConsumeEvent1Client) Send(m *reflexpb.ConsumeRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *exServerConsumeEvent1Client) Recv() (*reflexpb.Event, error) {
	m := new(reflexpb.Event)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *exServerClient) StreamEvent2(ctx context.Context, in *reflexpb.StreamRequest, opts ...grpc.CallOption) (ExServer_StreamEvent2Client, error) {
	stream, err := c.cc.NewStream(ctx, &_ExServer_serviceDesc.Streams[2], "/exserverpb.ExServer/StreamEvent2", opts...)
	if err != nil {
		return nil, err
	}
...
type ExServerServer interface {
	...
	ConsumeEvent1(ExServer_ConsumeEvent1Server) error
...
func _ExServer_ConsumeEvent1_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ExServerServer).ConsumeEvent1(&exServerConsumeEvent1Server{stream})
}

type ExServer_ConsumeEvent1Server interface {
	Send(*reflexpb.Event) error
	Recv() (*reflexpb.ConsumeRequest, error)
	grpc.ServerStream
}

type exServerConsumeEvent1Server struct {
	grpc.ServerStream
}

func (x *exServerConsumeEvent1Server) Send(m *reflexpb.Event) error {
	return x.ServerStream.SendMsg(m)
}

func (x *exServerConsumeEvent1Server) Recv() (*reflexpb.ConsumeRequest, error) {
	m := new(reflexpb.ConsumeRequest)
...
var _ExServer_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ConsumeEvent1",
			Handler:       _ExServer_ConsumeEvent1_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
...
func init() { proto.RegisterFile("exserver.proto", fileDescriptor_exserver_88aa69dfe8627805) }

var fileDescriptor_exserver_88aa69dfe8627805 = []byte{
	...
	,
}
